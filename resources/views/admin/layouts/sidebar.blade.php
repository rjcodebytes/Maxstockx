...
<aside id="sidebar" style="
  ...
  <ul style="list-style: none; padding: 20px 40px; margin: 0;">
    <li style="padding: 10px 0;">
      ...
      <a href="{{url('/admin/dashboard')}}" style="color: white; text-decoration: none;">Dashboard</a>
    </li>

    <li style="padding: 10px 0;">
      <i class="bi bi-book" style="margin-right: 10px;"></i>
      <a href="{{url('/admin/managecourses')}}" style="color: white; text-decoration: none;">Manage Courses</a>
    </li>

    <li style="padding: 10px 0;">
      <i class="bi bi-journal-check" style="margin-right: 10px;"></i>
      <a href="{{url('/admin/manageusers')}}" style="color: white; text-decoration: none;">Manage Users</a>
    </li>
